  ...
  return (
    <div className="relative py-4 sm:py-6 lg:py-8 min-h-screen flex flex-col">
      ...
      <div className="flex-1 w-full px-2 sm:px-4 lg:px-6 flex flex-col items-center justify-center">
        <div className="grid grid-rows-2 gap-8 w-full max-w-4xl justify-items-center">
          {/* First Row */}
          <div className="grid grid-cols-3 gap-6 sm:gap-8 lg:gap-12 w-full justify-items-center">
            {projects
              ...
              .map((project, index) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-purple-500/20 via-pink-500/20 to-cyan-500/20 rounded-xl lg:rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

                  <div className="relative h-full bg-gradient-to-br from-gray-900/90 to-gray-800/90 backdrop-blur-sm rounded-lg lg:rounded-xl border border-gray-700/50 overflow-hidden group-hover:border-purple-400/50 transition-all duration-300">
                    {/* Project Image */}
                    <div className="relative h-32 sm:h-40 lg:h-48 overflow-hidden">
                      ...
                      <div className="absolute top-2 left-2 sm:top-3 sm:left-3">
                        <div className="bg-gray-900/80 backdrop-blur-sm px-2 py-1 sm:px-3 sm:py-1.5 rounded text-xs sm:text-sm text-purple-400 font-mono border border-purple-400/30">
                    ...
                    <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between">
                      <div>
                        <h3 className="text-white text-sm sm:text-base lg:text-lg font-bold mb-2 group-hover:text-purple-300 transition-colors duration-300 line-clamp-2">
                          {project.name}
                        </h3>
                      </div>
                ...
                <div className="relative">
                  ...
                  <div className="absolute bottom-4 right-4 flex gap-2">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.9 }}
                      onClick={() =>
                        window.open(selectedProject.source_code_link, "_blank")
                      }
