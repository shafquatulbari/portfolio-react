  ...
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className="text-[#41b5f7]">Shafquat Ul Bari</span>
          </h1>
      ...
      <div className="absolute xs:bottom-10 bottom-32 w-full flex justify-center items-center">
        <a href="#about">
          <div className="w-[35px] h-[64px] rounded-3xl border-4 bg-[#41b4f72c] flex justify-center items-start p-2">
            <motion.div
              animate={{
                y: [0, 24, 0],
              }}
              ...
              className="w-3 h-3 rounded-full bg-[#41b4f7] mb-1"
            />
          </div>
        </a>
      </div>
